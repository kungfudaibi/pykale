...
class BoundEvaluationHandler(BaseUncertaintyEvaluator):  
    ...
    def _process_single_fold(self, fold_data: Dict, uncertainty_type: str, estimated_bounds: Dict, model: str, **kwargs) -> Dict:  
...
class ErrorEvaluationHandler(BaseUncertaintyEvaluator):  
    ...
    def _process_single_fold(self, fold_data: Dict, uncertainty_type: str, error_scaling_factor: float = 1.0, **kwargs) -> Dict:  
